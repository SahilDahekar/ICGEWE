  ...
  return (
        ...
        <div class="header__content">
            <div class="header__content-main">
                <h2 class="header__content-title">
                    <span class="header__content-title-small">International Conference on</span><br/>
            ...
            <div class="header__content-secondary">
                <p class="header__content-date"><FaCalendar className="icon"/><span> 8<sup>th</sup>,
                        9<sup>th</sup>
                        March 2023</span></p>
                <p class="header__content-email"><FaEnvelope className="icon"/><a
                        href="mailto:conference_entc@pvgcoet.ac.in">conference_entc@pvgcoet.ac.in</a></p>
            </div>
        </div>
    </div>
    {/* Header Ends  */}
    ...
    <div class="org">
        <div class="org__container">
            ...
            <h2 class="org__name">Pune Vidyarthi Griha's College of Engineering and Technology & G K Pate (Wani)
                Institute of Management <br/><span class="org__name-line2">Approved by AICTE, DTE (Code: 6274) |
            ...
            <div class="hounarables__primary">
                ...
                <div class="hounarables__primary__members">
                    <div class="hounarables__primary__member">
                        <h4 class="hounarables__primary__member-name">Hon. Shri. S.P. Redekar</h4>
                        <p class="hounarables__primary__member-position">Chairman, Pune Vidyarthi Griha (PVG) and<br/>
                            Director,
    ...
    <div id="about" class="conf">
        <div class="conf__container-about">
            ...
            <p class="conf-about">
                The International Conference on Gender Equality and Women Empowerment (ICGEWE-2023) is organized on 8th
                &
                9th March 2023 to celebrate “International Women Day” by the Department of Electronics &
                Telecommunication
                Engineering, PVG's College of Engineering and Technology and G.K. Pate (W) Institute of Management in
                association with Novateur Publications, Pune, India. The ICGEWE-2022 aims to open a wide online platform
                to
                present and share knowledge on good practices, actions, areas of improvement related to Gender Equality
                and
                Women Empowerment.
            </p>
        </div>
        ...
        <div class="conf__obj">
            <div class="conf__container">
                ...
                <ol class="conf__obj-list">
                    ...
                    <li class="conf__obj-item">
                        To inspire the society for Gender Equality by providing an interactive platform.
                    </li>
                    <li class="conf__obj-item">
                        To empower women for overall development of the society by creating awareness about the
                        different
            ...
            <svg class="bg-blob3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                <path fill="#FFDDE1"
            ...
            <div class="conf__container">
                ...
                <ol class="conf__out-list">
                    <li class="conf__out-item">
                        Better understanding of Woman's strengths through interactions and greater social connect.
                    </li>
                    <li class="conf__out-item">
                        Improved insights into the multidimensionality of womanhood.
                    </li>
                    <li class="conf__out-item">
                        Increased awareness about Gender Equality to achieve real impact on the quality of life for
                        women, men,
    ...
    <div id="topics" class="conf__topics">
        <div class="conf__topics-container">
            ...
            <p class="conf__topics-des">
                Following are the various topics of importance under consideration in ICGEWE -2023 but are not limited
                to
                these titles. Any suitable topic not mentioned but in line with the conference objectives can be
                considered.
            </p>
    ...
    <div id="timeline" class="dates">
        <div class="dates-container">
            ...
            <section class="timeline-section">
                <div class="timeline-items">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot"></div>
                        <div class="timeline-date">February 28<sup>th</sup>, 2023 <b>(till 6pm)</b></div>
                        <div class="timeline-content">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot"></div>
                        <div class="timeline-date">March 2<sup>th</sup>, 2023 <b>(till 6pm)</b></div>
                        <div class="timeline-content">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot"></div>
                        <div class="timeline-date">March 4<sup>th</sup>, 2023 <b>(till 6pm)</b></div>
                        <div class="timeline-content">
                            <h3>Last date of Registration for both attendees and presenter</h3>
                        </div>
                    </div>
                </div>
            </section>
        </div>
        <svg class="bg-blob4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#BBDEFB"
        ...
        <svg class="bg-blob5" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#BBDEFB"
